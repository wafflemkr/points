...
import static com.wafflemkr.points.web.rest.TestUtil.sameInstant;
...
public class WeightResourceIntTest {
    ...
    public void setup() {
        ...
        final WeightResource weightResource = new WeightResource(weightRepository, weightMapper, weightSearchRepository);
